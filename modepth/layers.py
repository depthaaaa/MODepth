...
class DWConv(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, stride=1, padding=1):
        ...
        self.depthwise_conv = Conv3x3(in_channels, in_channels, stride=stride, padding=padding, groups=in_channels)
        self.pointwise_conv = Conv1x1(in_channels, out_channels)
...
class Conv3x3(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, use_refl=True, stride=1, padding=0, groups=1):
        ...
        self.conv = nn.Conv2d(int(in_channels), int(out_channels), 3, stride=stride, padding=padding, groups=groups)
...
class Project3D(nn.Module):
    ...
    def forward(self, points, K, T):
        ...
        pix_coords_src = pix_coords
        pix_coords[..., 0] /= self.width - 1
        pix_coords[..., 1] /= self.height - 1
        pix_coords = (pix_coords - 0.5) * 2
        return pix_coords, pix_coords_src
